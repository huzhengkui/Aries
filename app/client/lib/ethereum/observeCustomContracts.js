...
//                 Events.remove(id);
//             } else {
//                 web3.okc.getBlock(log.blockHash, function(err, block){
//                     if(!err) {
    ...
    collectionObservers[collectionObservers.length] = CustomContracts.find({}).observe({
        ...
        */
        added: function(newDocument) {
            ...
            web3.okc.getCode(newDocument.address, function(e, code) {
                if(!e && code && code.length > 2 ){
                    ...
                    web3.okc.getBalance(newDocument.address, function(e, balance) {
                        if(!e && balance.gt(0)){
                            CustomContracts.update(newDocument._id, {$unset: {
                                disabled: false
                            }});
