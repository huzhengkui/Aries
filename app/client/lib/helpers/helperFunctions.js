...
Helpers.checkChain = function(callback){
    ...
    web3.okc.getCode(originalContractAddress, function(e, code){
...
Helpers.getENSName = function(address, callback) {
    ...
    var ensContract = web3.okc.contract(ensContractAbi);
    var resolverContract = web3.okc.contract(resolverContractAbi);
